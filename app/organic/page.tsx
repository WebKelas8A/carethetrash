        ...
        <div className="max-w-2xl mx-auto justify-center items-center flex h-screen">
          <div className="shadow-md border border-gray-200 rounded-lg max-w-sm p-4 sm:p-6 lg:p-8 bg-white w-full">
            <form className="space-y-6" action="#">
              <h3 className="text-xl text-center font-medium">Organic Waste</h3>
              <div>
                ...
                <input
                  ...
                  name="name"
                  id="name"
                  className=" bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg block w-full p-2.5 dark:border-gray-500 dark:placeholder-gray-400 outline-none focus:border-green-600"
